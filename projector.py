...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, default='/home/dung/Product/stylegan2-car-config-a.pkl')
    ...
    # parser.add_argument('files',default='/home/dung/Data/anh', metavar='FILES', nargs='+')
